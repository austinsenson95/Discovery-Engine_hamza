import type { User, NicheOption, Persona, ProgramName, PricingStrategy, RoadmapPhase, ActivityItem, CourseCurriculum, ReadinessQuiz } from '@/types';
...
export const mockReadinessQuiz: ReadinessQuiz = {
  answers: [2, 1, 2, 1, 0],
  rawScore: 8,
  score: 3,
  persona: 'Early Explorer',
  weakestArea: 'existing_assets',
  actionTips: quizActionTips['existing_assets'],
